  ...
  if (!language || isChangingLanguage) {
    return (
      <LanguageGateway 
        ...
        // Changed onSelectClose to onClose to match LanguageGatewayProps interface
      ...
      <main className="flex-grow pt-[80px] lg:pt-[130px]">
        {currentPage === Page.Home && (
          <>
            ...
            <section className="py-12 lg:py-32 bg-white px-6">
              <div className="container mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-8 lg:mb-16 gap-6 px-2">
            ...
            <section className="py-16 lg:py-48 bg-charcoal text-white text-center px-6 relative overflow-hidden">
              ...
              <div className="max-w-4xl mx-auto relative z-10">
                <div className="flex justify-center gap-1 mb-6 sm:mb-12 text-gold">
                  {[...Array(5)].map((_, i) => <Star key={i} size={16} fill="currentColor" />)}
                </div>
                <h3 className="text-xl sm:text-3xl lg:text-6xl font-serif mb-6 sm:mb-12 italic leading-[1.4] tracking-tight px-4 lg:px-0">
